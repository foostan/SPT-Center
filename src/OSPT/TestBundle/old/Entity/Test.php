...
class Test
{
	 ...
	 * @var ArrayCollection
	 *
	 * @ORM\OneToMany(targetEntity="Test_Problem", mappedBy="test")
	 */
	private $test_problems;
	...
	{
		$this->test_problems = new ArrayCollection();
     ...
     * Add test_problems
     *
     * @param OSPT\TestBundle\Entity\Test_Problem $test_problems
     */
    public function addTest_Problem(\OSPT\TestBundle\Entity\Test_Problem $test_problems)
    {
        $this->test_problems[] = $test_problems;
    }
     ...
     */
    public function getTestProblems()
    {
        return $this->test_problems;
    }
